...
void Prim::Prim_SortVector(){
    ...
    //-----------------------------------------------------
     ...
     // Here i have used map data structure and greater operator that sorts map in decending order.



    sort(mVec.begin(), mVec.end(), [](const pairX& a, const pairX& b) {
        // Compare the second values in reverse order
