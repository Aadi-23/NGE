...
void Frustum::Frustum_EvalPlaneNormals(){
    ...
    For(i, 3) a[i] = mUR1[i] - FrustumEye[i];
    For(i, 3) b[i] = mUL1[i] - FrustumEye[i];
    Vec_CrossProd(mN_Up, a, b);
    Vec_Normalize(mN_Up);
    ...
    //--------------------------------------------
    //--------------------------------------------Down
    For(i, 3) a[i] = mDL1[i] - FrustumEye[i];
    For(i, 3) b[i] = mDR1[i] - FrustumEye[i];
    Vec_CrossProd(mN_Down, a, b);
    Vec_Normalize(mN_Down);
    //--------------------------------------------
    //--------------------------------------------Far
    For(i, 3) a[i] = mDL1[i] - mDR1[i];
    For(i, 3) b[i] = mDL1[i] - mUL1[i];
    Vec_CrossProd(mN_Far, a, b);
    Vec_Normalize(mN_Far);

    //--------------------------------------------
    //--------------------------------------------Near
    For(i, 3) a[i] = mUR1[i] - mDR1[i];
    For(i, 3) b[i] = mUR1[i] - mUL1[i];
...
int Frustum::Frustum_CullObj(const double pos[3], double r){
    ...
    //--------------------------------------------
    For (i,3) v[i] = FrustumEye[i] - pos[i];
    //--------------------------------------------Orange
